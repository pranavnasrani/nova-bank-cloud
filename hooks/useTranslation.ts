...
const translations = {
  ...
  es: {
    ...
    cards: "Tarjetas",
    loans: "Préstamos",
    spendingThisMonth: "Gastos de este mes",
    // Cards Screen
  ...
  th: {
    ...
    cards: "บัตร",
    loans: "สินเชื่อ",
    spendingThisMonth: "ค่าใช้จ่ายเดือนนี้",
  ...
  tl: {
    ...
    cards: "Mga Card",
    loans: "Mga Loan",
    spendingThisMonth: "Gastusin Ngayong Buwan",
...
// FIX: Explicitly typed LanguageProvider as a React.FC to ensure it is correctly recognized as a component that accepts children, resolving the type error in index.tsx.
