...
import { UserIcon, LockIcon, ChevronLeftIcon, MailIcon } from './icons';
      ...
      >
        ...
        >
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <InputField icon={<LockIcon />} type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password (min. 6 chars)" />
